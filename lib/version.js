...
class VersionUtils {
     ...
     * @returns {Promise}
     */
    static updateJsonFile(options, packageVersion, jsonFilePath) {
    ...
    static updateJsonFilesIfNeeded(options, packageVersion) {
        if (options && options.jsonFiles && options.jsonFiles.length > 0) {
            return Promise.all(
                options.jsonFiles.map(jsonFilePath => VersionUtils.updateJsonFile(options, packageVersion, jsonFilePath))
            );
        }
