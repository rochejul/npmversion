...
module.exports = class VersionUtils {
        ...
        if (!options || options.help) {
            ...
            if (VersionUtils.hasFoundPackageJsonFile()) {
                ...
                if (options.unpreid) {
                    ...
                    packageJsonVersion = VersionUtils.incrementPackageVersion(packageJsonVersion, level, options.preid);
                }
    ...
    static incrementPackageVersion(packageVersion, level, preid) {
        return semver.inc(VersionUtils.unpreidPackageVersion(packageVersion), level, preid);
    }
