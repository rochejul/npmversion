    ...
    describe('and the method "pool" ', function () {
        ...
        it('should execute pool the promises in parallel', function () {
            ...
            return Promises
                ...
                .then(results => {
                    expect(results).deep.equals(['Used timeout: 750 / inc: 3', 'Used timeout: 150 / inc: 1', 'Used timeout: 350 / inc: 2']);
                });
        });
        ...
        it('should adapt the logic on pool size', function () {
            ...
            return Promises
                ...
                .then(results => {
                    expect(results).deep.equals(['Used timeout: 750 / inc: 1', 'Used timeout: 150 / inc: 2', 'Used timeout: 350 / inc: 3']);
                });
        });
    });
